...
public abstract class SystemRestController<T extends BasicEntity<ID>, ID> extends RestrictedRestController<T, ID> {
    @Autowired
    ...
    public @ResponseBody ResponseEntity<?> search(
        ...
        return ResponseEntityUtil.pages(page, resourceAssembler);
    }
    ...
    public @ResponseBody ResponseEntity<?> findAll(
        ...
        return ResponseEntityUtil.list(list, resourceAssembler);
    }
    ...
    public @ResponseBody ResponseEntity<?> findOne(
            ...
            PersistentEntityResourceAssembler resourceAssembler) throws Exception {
        T entity = getOne(id);
        return ResponseEntityUtil.entity(entity, resourceAssembler);
    }
